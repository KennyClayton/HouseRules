    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, 7, 4, "Mow the lawn" },
                    { 2, 2, 1, "Fold the laundry" },
                    { 3, 1, 2, "Load and unload dishwasher" },
                    { 4, 2, 4, "Mop the floors" },
                    { 5, 5, 5, "Clean the bathrooms" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, new DateTime(2023, 10, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 2, 3, new DateTime(2023, 10, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 3, 5, new DateTime(2023, 10, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 }
                });
